...
let GameRepository = class GameRepository {
    ...
    findById(id, projection, options) {
        return (0, rxjs_1.from)(this.gameModel.findById(id, projection, options)).pipe((0, rxjs_1.map)((gameDocument) => gameDocument.toJSON()));
    }
    updateOne(filter, update, options) {
        return (0, rxjs_1.from)(this.gameModel.updateOne(filter, update, options)).pipe((0, rxjs_1.tap)((gameDocument) => console.log("updateOne", { gameDocument })));
    }
